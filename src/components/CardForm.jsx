	...
	return (
		<form className='cardForm' onSubmit={handleSubmit}>
			<label className='labelname'>
				Cardholder Name
				<input type='text' placeholder='e.g. hari' onChange={handleInput} name='name' className='card-input' />
			</label>
			<p className='info info--hidden' aria-live='polite'></p>

			<label className='labelnumber'>
				Card Number
				<input type='text' placeholder='e.g. 0000 0000 0000 0000' onChange={handleInput} name='number' className='card-input' minLength={19} />
			</label>
			<p className='info info--hidden' aria-live='polite'></p>
